...
#3: 6kui Задача вывести номер телефона в нужном формате, числа заданы в массиве. Предполагается, что данные уже проверены, то есть чисел в массиве достоверно 10.
